...
/**
 * @author ganeshan
 * Test case where the universal query is satisfied
 * from node root to node 3 for the pattern "constructor1 constructor2"
 * 
 */
public class GraphBuilder$v1 implements IGraphEngine {

    private Set initialNodes;
    
    public GraphBuilder$v1() {
    ...
    private void createGraph() {
        ...
        _edge4.setConstructor(new Constructor2());
