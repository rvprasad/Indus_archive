 ...
 */
public abstract class AbstractStmtXMLizer
  extends AbstractStmtSwitch {
	 ...
	 * </p>
	 */
	AbstractValueXMLizer valueXMLizer;
	...
	/**
	 * Creates a new AbstractStmtXMLizer object.
	 *
	 * @param valueXML DOCUMENT ME!
	 */
	AbstractStmtXMLizer(final AbstractValueXMLizer valueXML) {
	...
	public final void caseGotoStmt(GotoStmt v) {
		out.write("<goto_stmt id=\"" + newId + "\" target=\"" + getIdForStmt((Stmt) v.getTarget()) + "\"/>");
	}
	...
	public final void caseIfStmt(IfStmt v) {
		out.write("<if_stmt id=\"" + newId + " true_target id=\"" + getIdForStmt(v.getTarget())
			+ "\" false_target id=\"" + getIdForNextStmt() + "\"/>");
		out.write("<condition>");
	...
	public final void caseLookupSwitchStmt(LookupSwitchStmt v) {
		out.write("<lookupswitch_stmt id=\"" + newId + "\" defaultTargetId=\""
			+ getIdForStmt((Stmt) v.getDefaultTarget()) + "\">");
		out.write("<key>");
		v.getKey().apply(valueXMLizer);
		out.write("</key>");

		for (int i = 0; i <= v.getTargetCount(); i++) {
			out.write("<case value=\"" + v.getLookupValue(i) + "\" targetId=\"" + getIdForStmt((Stmt) v.getTarget(i))
				+ "\"/>");
		}
	...
	public final void caseTableSwitchStmt(TableSwitchStmt v) {
		...
		for (int i = v.getLowIndex(); i <= v.getHighIndex(); i++) {
			out.write("<case value=\"" + i + "\" targetId=\"" + getIdForStmt((Stmt) v.getTarget(i)) + "\"/>");
		}
	 ...
	 * @return DOCUMENT ME!
	 */
	protected abstract String getIdForNextStmt();
	 ...
	 * @return DOCUMENT ME!
	 */
	protected abstract String getIdForStmt(final Stmt stmt);
	 ...
	 * <p></p>
	 */
	protected abstract void newMethod(final Object methodId);
