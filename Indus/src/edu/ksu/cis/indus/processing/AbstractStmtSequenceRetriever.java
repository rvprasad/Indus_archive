...
/**
 * This implementation provides infrastructure to store information pertaining to higher-level structures (stmt graph or
 * basic block graph) based on which concrete implementation can generate statement sequences.   <i>The user should call
 * atleast one of <code>setBbgFactory()</code> or <code>setStmtGraphFactory()</code> with a non-null argument before using
 * an instance of this class.</i>
 *
