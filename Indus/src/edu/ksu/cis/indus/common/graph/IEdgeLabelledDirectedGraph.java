...
public interface IEdgeLabelledDirectedGraph
  extends IDirectedGraph {
	 ...
	 * @version $Revision$
	 */
	public interface IEdgeLabelledNode
	  extends INode {
		/**
		 ...
		 */
		Collection getIncomingEdgeLabels();
		 ...
		 * @post result != null and result.oclIsKindOf(Collection(ILabel))
		 */
		Collection getOutGoingEdgeLabels();
		 ...
		 * @pre label != null
		 */
		Collection getPredsViaEdgesLabelled(final IEdgeLabel label);
		 ...
		 * @pre label != null
		 */
		Collection getSuccsViaEdgesLabelled(final IEdgeLabel label);
