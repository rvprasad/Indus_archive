...
public interface IMutableDirectedGraph<N extends IMutableNode<N>> {
	 ...
	 */
	boolean addEdgeFromTo(final N src, final N dest);
	 ...
	 */
	boolean removeEdgeFromTo(final N src, final N dest);
	 ...
	 * @pre node != null
	 */
	boolean removeNode(final N node);
}
