...
public interface IExceptionRaisingInfo
  extends IIdentification,
	 ...
	 */
	Object ID = "exception throw Information";
	 ...
	 */
	Collection getExceptionsThrownBy(final Stmt stmt, final SootMethod method);
	 ...
	 */
	Collection getUncaughtExceptionsThrownBy(final Stmt stmt, final SootMethod method);
