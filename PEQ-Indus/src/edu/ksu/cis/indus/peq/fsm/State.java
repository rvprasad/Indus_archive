...
public class State implements IState {
    ...
    public void setExitingTransitions(ITransition trans) {
        this.exitingTransitions.add(trans);
    }
	...
	/**
	 * @return Returns the eclosure.
	 */
	public Set getEclosure() {
		return eclosure;
	}
	/**
	 * Add the set of states to this state's eclosure/
	 * @param eset The set of eclosed states.
	 */
	public void setEclosure(final Set eset) {
		this.eclosure.addAll(eset);
	}
}
