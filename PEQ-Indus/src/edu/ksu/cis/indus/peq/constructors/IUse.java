 ...
 */
public class IUse extends GeneralConstructor {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof IUse)) {
            return false;
        }
        IUse rhs = (IUse) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1737511775, -98171143).appendSuper(
