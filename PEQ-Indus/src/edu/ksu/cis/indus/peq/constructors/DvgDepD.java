 ...
 */
public class DvgDepD extends GeneralConstructor {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof DvgDepD)) {
            return false;
        }
        DvgDepD rhs = (DvgDepD) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-1629813591, 1386610641).appendSuper(
