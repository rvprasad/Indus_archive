 ...
 */
public class SyncDepT extends GeneralConstructor {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof SyncDepT)) {
            return false;
        }
        SyncDepT rhs = (SyncDepT) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1463113703, 81674759).appendSuper(
