 ...
 */
public class DivergenceFilter extends ViewerFilter {
    ...
    public boolean select(Viewer viewer, Object parentElement, Object element) {
        if (parentElement instanceof RightPaneTreeParent) {
            ...
            if (_rtp.getStatement().equals("Dependees") || _rtp.getStatement().equals("Dependents")) {
                if (element instanceof RightPaneTreeParent && ((RightPaneTreeParent) element).getStatement().equals("Divergence")) {
                    return false;
                }
            }            
        }
