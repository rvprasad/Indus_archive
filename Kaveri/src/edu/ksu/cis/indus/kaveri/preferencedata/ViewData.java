...
public class ViewData {
	 ...
	 *
	 * @param setcontrol The control to set.
	 */
	 ...
	 *
	 * @param setinterference The interference to set.
	 */
	 ...
	 *
	 * @param setready The ready to set.
	 */
	 ...
	 *
	 * @param setsynchronization The synchronization to set.
	 */
	...
	public boolean equals(final Object arg0) {
		if (arg0 instanceof ViewData) {
			...
			_result = (control == _cdata.isControl()) & (data == _cdata.isData());
