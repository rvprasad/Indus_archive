 ...
 * @author Ganeshan 
 */
public class DataPredecessor extends DependenceBaseClass
  implements IEditorActionDelegate
	...
	protected List handleDependence(SootMethod method, Stmt stmt) {
		return handleDependees(method, stmt, IDependencyAnalysis.IDENTIFIER_BASED_DATA_DA);				
	}
