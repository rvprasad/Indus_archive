 ...
 * @author Ganeshan 
 */
public class ReadySuccessor extends DependenceBaseClass  
	{
	...
	protected List handleDependence(SootMethod method, Stmt stmt) {
		...
		final List _tList = handleDependents(method, stmt, IDependencyAnalysis.READY_DA);		
	...
	protected String getDependenceAnnotationKey() {
		return "indus.slice.ReadyDependencehighlightAnnotation";
	}
}
