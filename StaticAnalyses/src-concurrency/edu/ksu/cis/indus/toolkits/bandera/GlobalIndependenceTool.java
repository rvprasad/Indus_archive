...
public final class GlobalIndependenceTool
  ...
  implements Tool {
	 ...
	 *
	 * @invariant independent.oclIsKindOf(Collection(String))
	 */
	private Collection independentClassNames;
	 ...
	 *
	 * @param configurationString the list of FQN of independent classes.  If <code>null</code> then the default set mentioned in
	 * 		  <code>edu.ksu.cis.indus.staticanalyses.independence.AtomicStmtDetector</code>.
	 *
	...
	public String getConfiguration() {
		...
		final Iterator _i = independentClassNames.iterator();
