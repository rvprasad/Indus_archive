...
public class Util {
	...
	/**
	 * <p>Checks if the given classes are on the same class hierarchy branch.  This means either one of the classes should be
	 * the subclass of the other class.</p>
	...
	public static boolean isHierarchicallyRelated(SootClass class1, SootClass class2) {
		return isAncestorOf(class1, class2.getName()) || isAncestorOf(class2, class1.getName());
	}
