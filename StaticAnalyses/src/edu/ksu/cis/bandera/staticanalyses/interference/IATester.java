...
public class IATester
  extends Tester {
	...
	private void execute() {
		...
		AbstractAnalyzer aa = OFAnalyzer.getFSOSAnalyzer("IATester");
		...
		EquivalenceClassBasedAnalysis ecba = new EquivalenceClassBasedAnalysis(scm, cg, tg);
		ecba.hookup(ppc);
		ppc.process();
